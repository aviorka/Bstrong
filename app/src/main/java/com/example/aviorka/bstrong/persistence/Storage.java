...
//        db.execSQL("insert into [plan] values(null,5, 5, 3, 3, 10,\"Lay on your back on the floor having the palm of your hands leaning on the floor and your elbows bent. Try elevating your body by streaching your elbow for 10 seconds, than bend down to rest for 5 seconds\", \"hands_on_floor\")");
        ...
        db.execSQL("insert into [plan] values(null,4, 3, 1, 3, 8,\"Medicine Ball Slams  - 3 sets 8 reps. Stand straight with your feet set shoulder width apart. Keep your shoulders back and let your arms relax.Bend over to pick up the ball.Lift the ball over your head. Slam the ball into the ground.\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,4, 3, 2, 3, 10,\"Medicine Ball Slams  - 3 sets 10reps. Stand straight with your feet set shoulder width apart. Keep your shoulders back and let your arms relax.Bend over to pick up the ball.Lift the ball over your head. Slam the ball into the ground.\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,4, 3, 3, 3, 10,\"Weighted Superman - 3 sets 10 sec .Draw shoulder blades down your back and peel chest and chin off the floor. Slowly raise arms and legs as high as possible, engaging core and back muscles.Hold the position at the top for a few counts while pretending you have a cape around your neck. Lower your body back onto the mat\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,4, 4, 1, 3, 10,\"Medicine Ball Bicep Curls - 3 sets 10 reps. Stand with feet shoulder-width apart and hold a medicine ball at waist level.Keeping your elbows close to your sides, exhale while curling the ball upward to your chest.Inhale as you lower your arms back to the starting position.\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,4, 4, 2, 3, 15,\"Medicine Ball Bicep Curls -2 sets 15 reps. Stand with feet shoulder-width apart and hold a medicine ball at waist level.Keeping your elbows close to your sides, exhale while curling the ball upward to your chest.Inhale as you lower your arms back to the \", \"resource_image_id\")");
        ...
        db.execSQL("insert into [plan] values(null,4, 6, 1, 3, 10,\"Shoulder press - 3 sets 10 reps . Extend your arms to the ceiling, reaching the ball overhead, then slowly lower the ball back to the starting position\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,4, 6, 2, 3, 12,\"Shoulder press - 2 sets 12 reps . Extend your arms to the ceiling, reaching the ball overhead, then slowly lower the ball back to the starting position\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,4, 6, 3, 3, 15,\"Shoulder press - 2 sets 15 reps . Extend your arms to the ceiling, reaching the ball overhead, then slowly lower the ball back to the starting position\", \"resource_image_id\")");


        //No equipment
        db.execSQL("insert into [plan] values(null,5, 1, 1, 3, 10,\"Jump squats - 3 sets 10 reps . To start, place your feet apart in a position in which you will be able to jump your to highest height. With your feet in that position, drop your hips back as far as possible while pushing your knees out to have them under your hips. Jump up with a single motion, jumping as high as you can\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,5, 1, 2, 3, 10,\"Bulgarian Split Squats - 3 sets 10 reps. Place your feet on a surface, be it a chair, bed, or a bench, and sink down as low as you can. Drive vertically upward so that one foot is off the floor\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,5, 1, 3, 3, 10,\"Curtsy Lunge - 3 sets 10 reps. Tuck your one leg behind the other, and with legs crossed, sink down. You will feel a deep and tight activation of your glute and outer thigh. Come back to an upright position.\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,5, 2, 1, 3, 10,\"Push-ups - 3 sets 10 rep . start in a plank position with your pelvis tucked in, your neck neutral, and your palms directly under your shoulders. Make sure your shoulders are rotated back and down\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,5, 2, 2, 3, 10,\"Diamond push up - 3 sets 10 reps. placing your hands close together until your thumbs and index fingers touch forming a “diamond” shape.\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,5, 2, 3, 3, 4,\"Push up hold . 3 sets 4 reps. Position yourself in a plank position, supporting your body with your toes and place your hands underneath your shoulders with elbows extended. Keep your abs engage and prevent letting your hips sag.\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,5, 3, 1, 3, 10,\"Supermans -  3 sets 10 reps. Lie prone on a mat with your legs extended, ankles slightly plantarflexed, arms extended overhead with palms facing each other. Gently inhale and lower your legs and arms back towards your starting position without any movement in your low back or hip\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,5, 3, 2, 3, 10,\"Scapular push-ups -3 sets 10 reps. Keep hands shoulder-width apart and your back straight (no rounding or slouching here) as you begin the move. When you’re ready to begin, keep your arms straight as you squeeze your shoulder blades together and apart.\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,5, 3, 3, 3, 5,\"Atomic Burpee - 3 sets 5 reps. Lie down on your back, keeping your legs straight with your arms bent behind your head.Do a sit-up, but instead of lowering back down to the ground, jump to a standing position.Next comes the burpee. Jump down into a push-up position, complete a push-up, jump up to a squat, and jump straight up toward the ceiling.\", \"resource_image_id\")");
        db.execSQL("insert into [plan] values(null,5, 4, 1, 3, 6,\"Commando cin-ups - 3 sets 6 reps. Pull yourself up with your head to the left of the bar. Try to touch the bar with your right shoulder.Then lower yourself back down to the starting position in a controlled manner. Then, pull yourself up with your head to the right of the bar. Try to touch the bar with your left shoulder.\", \"resource_image_id\")");

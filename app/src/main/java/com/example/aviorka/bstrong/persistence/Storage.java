...
public class Storage extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into [plan] values(null,5, 6, 3, 3, 10,\"Lie on your back on the floor with your knees bent and your feet flat on the floor. Place your arms out to your sides at a 45-degree angle, your palms facing up. Now try to make your tummy as skinny as possible and hold it that way—this gives you a tight core—while breathing normally. That's the starting position\", \"Step_up_with_Knee_Raise-1\")");

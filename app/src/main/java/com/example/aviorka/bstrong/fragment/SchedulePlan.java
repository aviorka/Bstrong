...
public class SchedulePlan extends AppCompatActivity  implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        db = Storage.geInstance(this.getBaseContext());
        setContentView(R.layout.fragment_schedule_plan);
